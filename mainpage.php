...
<div class="col-md-12">
<div class="form-area"> 
<form method="POST" action="inserttables.php" >
<br style="clear:both">
  <center>
	<button type="submit" id="submit" name="sub1" class="btn btn-danger ribbon">Insert</button>
</center>
</form>
<form method="POST" action="updatetables.php" >
<br style="clear:both">

	<button type="submit" id="submit" name="sub2" class="btn btn-danger ribbon">Update</button>
...
<br style="clear:both">
	...
	<button type="submit" id="submit" name="sub3" class="btn btn-danger ribbon">Queries</button>
